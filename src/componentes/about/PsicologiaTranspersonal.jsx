          ...
          <div className={estilos.ts2}>
              <div className={estilos.cn}>
                  ...
                  <div className={estilos.texto}>
                    ...
                    <p>Con el tiempo, la pasión se tradujo en formación, experiencia y una comunidad que crece desde la autenticidad. Cada palabra, sesión y creación digital refleja ese compromiso con el alma y la sanación.
